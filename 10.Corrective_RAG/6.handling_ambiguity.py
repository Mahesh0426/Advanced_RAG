...
class State(TypedDict):
    ...
    web_query:str  # this is the re written query for web search
...
# =========== 2nd NODE ===========
#8. Doc-level filtering node - it will filter the documents based on the score of each document which is return by the doc_eval_chain.
...
# =========== 3rd NODE ===========
#11. refining (decompose - filter - recompose) - it will refine the retrieved documents or web search results based on the score of each document or web search results.
...
# =========== 4th NODE ===========
#Rewrite query node - it will rewrite the question into a web search query composed of keywords.
...
# =========== 5th NODE ===========
# Web search node - it will search the web using the rewritten query.
...
# =========== 6th NODE ===========
#12. generate node - it will generate the final answer based on the refined context.
